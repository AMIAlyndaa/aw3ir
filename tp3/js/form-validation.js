window.onload = function () {
    ...
    const resultContainer = document.getElementById("resultContainer"); // Récupérer le conteneur de résultats
    ...
    form.addEventListener("submit", function (event) {
      ...
      // Liste des IDs des champs de texte
      const fields = ["nom", "prenom", "adressePostale"]; // Changez ici si besoin
      ...
      // Affiche la modale appropriée en fonction de la validité du formulaire
      if (formValid) {
        // Si le formulaire est valide, afficher la modale de la carte
        showMapModal();
  
        // Afficher les résultats du formulaire
        displayFormResults();
      } else {
        // Affiche la modale d'erreur si les champs ne sont pas valides
        showErrorModal();
      }
    });
    ...
    function displayFormResults() {
        ...
        // Affichage des résultats dans le conteneur de la modale
    ...
    function showMapModal() {
      // Modification du contenu de la modale pour afficher la carte
